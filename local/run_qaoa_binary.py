...
from workflows_binary_encoding import get_cost_model, get_deadline_model, get_machine_usage_model, is_correct, \
...
def get_filename(args):
    ...
    filename += f'AerSimulator_{args.optimizer}_{str(args.reps)}_Workflows_binary_{suffix}.json'
    return filename
...
def solve_and_store_result(qaoa):
    result = None
    try:
        result = qaoa.solve_hamiltonian(qubit_op, offset)
    finally:
