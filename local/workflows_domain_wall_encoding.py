...
def get_stats_for_result(dict_res):
    ...
    return sample_most_likely(
        dict_res), optimal, correct, feasible, incorrect, correct_config, incorrect_config, feasible_config
...
def get_indices():
    ...
    rev_states = [i[::-1] for i in states]
    states_int = [int(i, 2) for i in rev_states]
    return states_int
